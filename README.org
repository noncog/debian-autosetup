...
* About
The install.sh bash script is created from this README.org file using Emacs, org-mode, and org-babel's literate programming.
...
** Git Sources
I use git to source my theme and i3-gaps for debian. The installer can clone any repo into the downloads directory. It is up to you to process the downloaded content yourself.
#+BEGIN_SRC sh :tangle install.sh
git_sources=(
